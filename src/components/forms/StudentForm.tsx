...
const schema = z.object({
    username: z.string()
        .min(3, {message: 'Username is required, at least three characters!'})
        .max(20, {message: 'Username must be at most 20 characters long!'}),
    email: z.email('Email should have @ character!'),
    password: z.string()
    ...
    img: z.instanceof(File, {message: 'User image is required!'}),
});
